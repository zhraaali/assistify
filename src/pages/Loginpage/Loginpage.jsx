    ...
    return (
        <div className='loginpage' style={{ position: 'relative' }}>
            ...
            <div>
                ...
                <Hero />
                <div className='form-div' style={{position:'absolute',top:'13%',left:'20%',zIndex:'5',borderRadius:'19px' ,
                display:'flex',
                flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                <Form style={{width:'70%',height:'100%',backgroundColor:'#FFFFFF',marginLeft:'50%',borderRadius:'19px'}}>
                        <h2 style={{color:'#0A0E3F',textAlign:'center',paddingTop:'10%'}}>تسجيل دخول </h2>
                    <Form.Group className="mb-3" controlId="formBasicEmail" style={{display:'flex',
                flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                        {/* <Form.Label>ا</Form.Label> */}
                ...
                flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                        ...
                        <Form.Control  value="تسجيل دخول" style={{borderRadius:'20px',height:'2.4em',width:'70%',
